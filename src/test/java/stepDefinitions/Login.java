...
public class Login {
	...
	//--team
	 ...
	 LoginFactory loginobj = new LoginFactory(driver);
...
//		loginobj.logout_button();
//	    
//	}
//
//	@Then("The user should be redirected to home page with message {string}")
//	public void the_user_should_be_redirected_to_home_page_with_message(String expected_message) {
//		String ActualLogedOutMessage = loginobj.getLogOutMessage();
//		Assert.assertEquals(ActualLogedOutMessage, expected_message);
//	}
...
//		
//		boolean logedout = login.is_loggedout_messagedisplayed();
//		Assert.assertTrue(logedout);
//		logger.info(login.is_loggedout_messagedisplayed()); 
//	}
//
//}
